	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <a class="fa fa-facebook" href="https://www.facebook.com/minhvuog.dev/" target="_blank"></a>
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">Smart Phone Minh Vuong Mobile</a> - All rights reserved © 12th 2023 - Designed by
            <span style="color: #eee; font-weight: bold">Minh Vuong Duong</span></p>
    </div>`);
}
        ...
        <section>
            <ul class="flexContain">
                ...
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:12345678" style="color: #288ad6;">0866004703</a>
                </li>
            </ul>
        </section>
    </div>`);
